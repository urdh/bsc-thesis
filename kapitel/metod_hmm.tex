...
klassificering av testfilmerna ske på det sätt som beskrivs i
figur~\ref{fig:hmm-flowchart}.
 ...
 \begin{figure}[tbp]
  ...
  \caption[Klassificering av dynamiska gester med två, dem eller sju
  symboler]{Klassificering av dynamiska gester med två, fem eller sju
