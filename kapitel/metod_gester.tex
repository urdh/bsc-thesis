...
\begin{figure}[htb]
	\centering 
	\subfloat[Teckenspråk: A]{
		\includegraphics[height=2cm]{bilder/gest1.jpg}
		\label{fig:gester:A}
	}
	% ev. spacing
	\subfloat[Teckenspråk: B]{
		\includegraphics[height=2cm]{bilder/gest2.jpg}
		\label{fig:gester:B}
	}
	% ev. spacing
	\subfloat[Teckenspråk: C]{
		\includegraphics[height=2cm]{bilder/gest3.jpg}
		\label{fig:gester:C}
	}
	% ev. spacing
	\subfloat[Teckenspråk: D]{
		\includegraphics[height=2cm]{bilder/gest4.jpg}
		\label{fig:gester:D}
	}
	% ev. spacing
	\subfloat[Teckenspråk: E]{
		\includegraphics[height=2cm]{bilder/gest5.jpg}
		\label{fig:gester:E}
	}
	\\
	% ev. spacing
	\subfloat[Sten]{
		\includegraphics[height=2cm]{bilder/gest6.jpg}
		\label{fig:gester:sten}
	}
	% ev. spacing
	\subfloat[Sax]{
		\includegraphics[height=2cm]{bilder/gest7.jpg}
		\label{fig:gester:sax}
	}
	% ev. spacing
	\subfloat[Påse]{
		\includegraphics[height=2cm]{bilder/gest8.jpg}
		\label{fig:gester:pase}
	}
	% ev. spacing
	\subfloat[Seger]{
		\includegraphics[height=2cm]{bilder/gest9.jpg}
		\label{fig:gester:spock}
	}
	% ev. spacing
	\subfloat[Spock]{
		\includegraphics[height=2cm]{bilder/gest10.jpg}
