...
matlabfunktionen \texttt{bwareaopen}, som är en inbyggd marfologisk
öppningsfunktion. Till skillnad från metoden beskrivet i
\ref{sec:morph} ställer \texttt{bwareaopen} inga
krav på områdets form utan endast area. Vad som är en lämplig area
...
kameran med vår upplösning ($320\cross240$ pixlar). Därefter loopar vi
