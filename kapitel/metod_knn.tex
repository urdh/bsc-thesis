...
\notes{Detta stycket är lite rörigt.}
...
samtliga femton egenskaper, och vi lät även $k$ variera mellan 1 och 13 för att få
en uppfattning av dess inverkan (se figur~\ref{fig:knn-optimering} för en
visualisering av resultaten). Trots att algoritmen är krävande att köra bör
