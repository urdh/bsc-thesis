...
använde, är s.k.~girig optimering. Detta kan delas in i två snarlika algoritmer, greedy forward resp.~backward selection. Framåtalgoritmen förlaras i figur~\ref{fig:knn-flowchart}. Bakåtalgoritmen är snarlik, men börjar istället med samtliga egenskaper inkluderade och plockar succesivt bort den som bidrar minst.
...
\citeasnoun{Jain97} utförde en undersökning av algoritmer för ural av egenskaper,
