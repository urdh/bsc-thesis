...
\notes{Ska det inte vara avstånd till överkant _eller_ vänsterkant}
...
\notes{Fel, betyder f avbildas på {0,1}. Ska vara f avbildar mängden
  av bildpunkter på mängden {0,1} eller dyl.}
