...
med övergångssannolikheter (se figur~\ref{fig:ergodisk}). Man kan alltså
...
förflyttning från
ett tillstånd till sig självt eller till nästa (man får alltså inte ''hoppa över'' tillstånd), ett val som ger upphov
...
\begin{figure}[tb]
  \centering
%  \includegraphics[width=\textwidth,trim=2cm 0.5cm 2cm 0,clip=true]{bilder/ourmodelHMM}
  \caption{}
  \label{hmm1}
\end{figure}
...
\begin{figure}[tb]
  \centering
%  \includegraphics[width=\textwidth,trim=2cm 0.5cm 2cm 0,clip=true]{bilder/ElmezainHMM}
  \caption{}
  \label{hmm2}
\end{figure}
