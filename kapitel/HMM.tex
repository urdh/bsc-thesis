...
För att kunna klassificera icke-statiska gester räcker det inte att 
...
\notes{Ska flyttas till bakgrund. HMM tillämpat på röst- och gestigenkänning är inget nytt. Redan i
slutet av 60-talet presenterade Baum (se referenser)\nocite{Baum66,Baum67,Baum68,Baum70,Baum72} den
...
(eller likvärdigt: antalet förflyttningar från tillståndet $S_i$), med
andra ord:
\begin{equation*}
...
vänster-höger-modellen, som den främsta då det gäller att modellera
