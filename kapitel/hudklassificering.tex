...
\notes{Förtydliga svarta/vita och $A$ jfrt. featurekapitlet.
Förklara att strukturelementet är en bild som man har som ''pensel'' och sveper
över huvudbilden med?}
\begin{figure}[tb]
	\centering 
...
sedan återställa den\notes{inte sant? återställa låter som fel ord..}. Detta ger upphov till två nya operationer:
