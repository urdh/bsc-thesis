...
matlabfunktionen \verb{bwareaopen}, som tar bort sammanhängande 
...
handen. Att på detta sätt jobba sig igenom bilden från höger har
tidigare gjorts av bl.a. XXX \marginpar{Hitta vem som letade från höger},
och det har visat sig effektivt. En alternativ metod för att leta från
...
där. Detta har gjorts av t.ex. XXX \marginpar{Hitta personen som kapat
handleder}.Detta görs genom att identifiera den största cirkel som får
plats helt i handen. Denna antas vara centrerad mitt i handen, och
dess längsta tangent i handen antas vara handleden. Handen är då den
