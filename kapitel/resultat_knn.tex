...
och värden på $k$. Med forward selection-algoritmen fås ett minimum då $k=7$ och 10 egenskaper inkluderades. Med backward elimination fås samma andel korrekta klassificeringar som minimum med $k=7$ och 7 inkluderade egenskaper.}
