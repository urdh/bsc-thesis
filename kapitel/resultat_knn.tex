...
användes är listade i tabell~\vref{tab:bestfeats}. Figur~\vref{fig:knn-optimering} visar mer exakt hur andelen korrekta
...
Figur~\vref{fig:knn-optimering} visar att optimering av vilka egenskaper som
inkluderas ger ett distinkt minimum redan vid tio egenskaper --- dessa tio
bästa listas i tabell~\vref{tab:bestfeats}. Ett urval av sex gester visar i
